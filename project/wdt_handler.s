...
; saved regs: R4 R5 R6 R7 R8 R9 R10 R11 R12 R13 R14 R15
	; start of prologue
	PUSH	R15		; Pushing registers into stack 
	PUSH	R14
	PUSH	R13
	PUSH	R12
	PUSH	R11
	...
	CALL	#wdt_c_handler
	; start of epilogue
	POP	R4                   ;after call of handler pop them immediately after
	POP	R5              
	POP	R6
	POP	R7
	POP	R8
	...
	POP	R14
	POP	R15
	cmp	#0, &redrawScreen    ; if redScn is set to 0 jump to ball_no_move if not ... 
	jz	ball_no_move
	and	#0xffef, 0(r1)	; clear CPU off in saved SR ; .. push copy of SR and turn on CPU
ball_no_move:	
